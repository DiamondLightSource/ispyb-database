...
GRANT SELECT ON BFactorFit TO ispyb_ro_nopii;
...
GRANT SELECT ON BLSampleImageMeasurement TO ispyb_ro_nopii;
GRANT SELECT ON BLSampleImageScore TO ispyb_ro_nopii;
GRANT SELECT ON BLSampleImage_has_AutoScoreClass TO ispyb_ro_nopii;
GRANT SELECT ON BLSampleImage_has_Positioner TO ispyb_ro_nopii;
...
GRANT SELECT ON BLSample_has_Positioner TO ispyb_ro_nopii;
...
GRANT SELECT ON BLSubSample_has_Positioner TO ispyb_ro_nopii;
...
GRANT SELECT ON LabContact TO ispyb_ro_nopii;
GRANT SELECT ON Laboratory TO ispyb_ro_nopii;
GRANT SELECT ON LDAPSearchBase TO ispyb_ro_nopii;
GRANT SELECT ON LDAPSearchParameters TO ispyb_ro_nopii;
...
GRANT SELECT ON Positioner TO ispyb_ro_nopii;
...
GRANT SELECT ON SW_onceToken TO ispyb_ro_nopii;
...
GRANT SELECT ON UserGroup_has_LDAPSearchParameters TO ispyb_ro_nopii;
...
GRANT SELECT ON zc_ZocaloBuffer TO ispyb_ro_nopii;
