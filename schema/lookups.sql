...
INSERT INTO `AdminVar` (`varId`, `name`, `value`) VALUES (4,'schemaVersion','1.13.0');
...
INSERT INTO `ComponentSubType` (`componentSubTypeId`, `name`, `hasPh`) VALUES (1,'Buffer',1),(2,'Precipitant',0),(3,'Salt',0),(4,'Cell',0),(5,'Matrix',0),(6,'Powder',0),(7,'Solution',1);
...
INSERT INTO `ConcentrationType` (`concentrationTypeId`, `name`, `symbol`) VALUES (1,'Molar','M'),(2,'Percentage Weight / Volume','%(w/v)'),(3,'Percentage Volume / Volume','%(v/v)'),(4,'Milligrams / Millilitre','mg/ml'),(5,'Grams','g'),(6,'Microlitre','uL'),(7,'Millilitre / Milligrams','ml/mg'),(8,'Millilitre','ml');
...
INSERT INTO `ExperimentType` (`experimentTypeId`, `name`, `proposalType`, `active`) VALUES (1,'Default',NULL,1),(2,'MXPressE',NULL,1),(3,'MXPressO',NULL,1),(4,'MXPressE_SAD',NULL,1),(5,'MXScore',NULL,1),(6,'MXPressM',NULL,1),(7,'MAD','MX',1),(8,'SAD','MX',1),(9,'Fixed',NULL,1),(10,'Ligand binding','MX',1),(11,'Refinement',NULL,1),(12,'OSC','MX',1),(13,'MAD - Inverse Beam','MX',1),(14,'SAD - Inverse Beam','MX',1),(15,'MESH','MX',1),(16,'XFE','MX',1),(17,'Stepped transmission','MX',1),(18,'XChem High Symmetry',NULL,1),(19,'XChem Low Symmetry',NULL,1),(20,'Commissioning',NULL,1),(21,'HPLC','SCM',1),(22,'Robot','SCM',1),(23,'Rack','SCM',1),(24,'Grid','SCM',1),(25,'Solids','SCM',1),(26,'Powder','SCM',1),(27,'Peltier','SCM',1),(28,'Spectroscopy','SCM',1),(29,'CD Spectroscopy','SCM',1),(30,'Microscopy','SCM',1),(31,'Imaging','SCM',1),(32,'CD Thermal Melt','SCM',1),(33,'Fixed Energy At Ambient With Robot','SCM',1);
...
INSERT INTO `ContainerType` (`containerTypeId`, `name`, `proposalType`, `active`, `capacity`, `dropPerWellX`, `dropPerWellY`, `dropHeight`, `dropWidth`, `dropOffsetX`, `dropOffsetY`, `wellDrop`) VALUES (1,'B21_8+1','',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,'B21_96','',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,'B21_1tube','',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,'I22_Capillary_Rack_20','',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(5,'I22_Grid_100','',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(6,'I22_Grid_45','',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(7,'P38_Capillary_Rack_27','',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(8,'P38_Solids','',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(9,'P38_Powder','',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(10,'B22_6','',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(11,'I11_Capillary_Rack_6','',1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `BLSampleGroupType` (`blSampleGroupTypeId`, `name`, `proposalType`, `active`) VALUES (1,'background','XPDF',1),(2,'container','XPDF',1),(3,'sample','XPDF',1),(4,'calibrant','XPDF',1),(5,'buffer','SCM',1),(6,'sample','SCM',1);
...
INSERT INTO `Column` (`columnId`, `name`, `active`) VALUES (1,'s75',1),(2,'s200',1),(3,'superose6',1),(4,'kw402.5',1),(5,'kw403',1),(6,'kw404',1),(7,'kw405',1),(8,'user supplied',1);
