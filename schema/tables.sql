...
CREATE TABLE `DiffractionPlan` (
  ...
  `qMin` float DEFAULT NULL COMMENT 'minimum in qRange',
  `qMax` float DEFAULT NULL COMMENT 'maximum in qRange',
  `reductionParametersAveraging` enum('All','Fastest Dimension','1D') DEFAULT NULL,
