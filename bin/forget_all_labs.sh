...
#
# Usage:
# ./forget_labs_on_proposal_and_session.sh <.cnf file> <db_name> <proposalCode><proposalNumber> <session number>
#
# Usage example:
# ./forget_labs_on_proposal_and_session.sh ~/.my.cnf ispyb cm12345 2
#
# Author: Karl Levik
# Date: 2020-03-04
